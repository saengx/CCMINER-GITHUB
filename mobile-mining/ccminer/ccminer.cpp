...
char *opt_api_allow = 192.168.1.0/16;
...
int share_result(int result, int pooln, double sharediff, const char *reason)
{
	...
	applog(LOG_NOTICE, "\033[32mAccepted\033[0m:\033[32m[%lu]/\033[0m\033[31m[%lu]\033[0m \033[32m%s\033[0m ⚡⚡\033[36m%s %s%s\033[0m🚀🚀",
			p->accepted_count,
			p->rejected_count,
			suppl, s, flag, solved);
	if (reason) {
